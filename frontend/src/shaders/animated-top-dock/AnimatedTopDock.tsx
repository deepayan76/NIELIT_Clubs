...
export type AnimatedTopDockProps = {
  ...
  activeId?: string;
  onItemSelect?: (id: string, href?: string) => void;
  logo?: ReactNode;
  onLogoClick?: () => void;
};
...
export function AnimatedTopDock({
    ...
    return (
      <div className={`animated-top-dock-component atd-modern${className ? ` ${className}` : ""}`}>
        ...
        <header className="atd-modern__bar">
          <a className="atd-modern__brand" href="#top-dock" onClick={(event) => { event.preventDefault(); onLogoClick?.(); }}>
            <span className="atd-modern__mark" aria-hidden="true">{logo ?? BRAND_MARK}</span>
    ...
    return (
      <div ref={glass.hostRef} className={`animated-top-dock-component atd-glass${className ? ` ${className}` : ""}`} data-dock-frame>
        ...
        <header className="atd-glass__rail">
          <a className="atd-glass__brand" href="#top-dock" onClick={(event) => { event.preventDefault(); onLogoClick?.(); }}>
            <span className="atd-glass__mark" aria-hidden="true">{logo ?? BRAND_MARK}</span>
  ...
  // Sable Dock Variant (Authored Centred Glass Capsule)
  return (
    <div className={`animated-top-dock-component atd-sable-root${className ? ` ${className}` : ""}`}>
