...
function Layer({
  ...
  return (
    <div
      aria-hidden="true"
      className={cn("hover-transition-layer", className)}
      style={{
        position: "absolute",
        inset: 0,
        width: "100%",
...
export function HoverTransition({
  ...
  switch (effect) {
    ...
    case "morph":
      animatedLayers = hoverLayer({
        ...
        opacity: active ? 1 : 0,
        transform: active
          ? "translate3d(0, 0, 2px) scale(1) rotate(0deg)"
          : `translate3d(${distanceX * 0.04}%, ${distanceY * 0.04}%, 2px) scale(.86) rotate(${vector.x < 0 ? -2 : 2}deg)`,
        transformOrigin: rippleOrigins[direction],
      });
      break;
    case "strips": {
  ...
  return (
    <div
      ...
      data-effect={effect}
      className={cn("hover-transition-root", className)}
      style={{
        position: "relative",
        overflow: "hidden",
        outline: "none",
    ...
    >
      <div
        className="hover-transition-stage"
        style={{
          position: "relative",
          width: "100%",
          height: "100%",
      ...
      >
        <div
          className={cn("hover-transition-before", duplicatesDefault && "invisible")}
          style={{
            position: "absolute",
            inset: 0,
            width: "100%",
            ...
            opacity: active && effect === "morph" ? 0 : 1,
            transform: active ? "scale(1.025)" : "scale(1)",
            transition: transitionFor(["transform", "filter", "opacity"]),
          }}
        >
          {before}
        </div>
        ...
        <div
          aria-hidden="true"
          className="hover-transition-glare"
          style={{
            position: "absolute",
            inset: 0,
            width: "100%",
