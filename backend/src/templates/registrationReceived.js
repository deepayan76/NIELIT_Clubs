 ...
 * Renders cross-client compatible, responsive HTML email for initial student registration receipt.
 */
export function getRegistrationReceivedTemplate({
  name,
  club,
  rollNumber,
  semester
...
<head>
  ...
  <title>NIELIT Tech Clubs — Registration Received</title>
</head>
<body style="margin: 0; padding: 0; background-color: #F8FAFC; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #111111; line-height: 1.6;">
  ...
  <div style="display: none; font-size: 1px; color: #F8FAFC; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
    We've received your registration for ${clubName} and it's now under review.
  </div>
          ...
          <tr>
            <td style="padding: 36px 36px 28px 36px;">
              ...
              <p style="margin: 0 0 24px 0; font-size: 15px; color: #444444; line-height: 1.6;">
                Thank you for registering for the NIELIT Tech Clubs. We're glad to have you join our community of students interested in technology, innovation, and practical engineering.
              </p>
                ...
                <tr>
                  <td style="padding: 20px 24px;">
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td style="padding: 6px 0; font-size: 14px; color: #666666;">Application Status</td>
                        <td style="padding: 6px 0; font-size: 13px;">
                          <span style="display: inline-block; padding: 3px 10px; background-color: #FEF3C7; color: #92400E; border: 1px solid #FCD34D; border-radius: 999px; font-weight: 700; font-size: 12px; letter-spacing: 0.04em;">
                            ◷ PENDING REVIEW
                          </span>
                        </td>
                      </tr>
              ...
              <p style="margin: 0 0 16px 0; font-size: 14px; color: #444444; line-height: 1.6;">
                Your registration has been successfully received. Your application is currently under review by the NIELIT Tech Clubs administration.
              </p>

              <p style="margin: 0 0 24px 0; font-size: 14px; color: #444444; line-height: 1.6;">
                You don't need to take any further action right now. We'll send you another email once your application has been reviewed.
              </p>

              <p style="margin: 0 0 28px 0; font-size: 14px; color: #16364A; font-weight: 600;">
                Until then, keep exploring, building, and learning. 🚀
              </p>
